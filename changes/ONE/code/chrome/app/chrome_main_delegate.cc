...
void ChromeMainDelegate::PostEarlyInitialization(bool is_running_tests) {
  ...
  cmd->AppendSwitchNative(switches::kDisableFeatures, 
    base::CommandLine::StringType(base::UTF8ToWide(media::kGlobalMediaControls.name)));
  ...
  // Thuan Test code form flag
  // // Update FeatureList here
  // //base::FeatureList::GetInstance()->InitializeFromCommandLine("",
  //   //media::kGlobalMediaControls.name
  //   // // "global-media-controls"
  //   //  );
  // std::ofstream ofs("out.txt", std::ofstream::app);
  // ofs << "PostEarlyInitialization: " << base::FeatureList::IsEnabled(media::kGlobalMediaControls) << std::endl;
  // base::FeatureList::GetInstance()->InitializeFromCommandLine("",
  //   media::kGlobalMediaControls.name
  //   // // "global-media-controls"
  //   );
  // ofs << "PostEarlyInitialization 2: " << base::FeatureList::IsEnabled(media::kGlobalMediaControls) << std::endl;
